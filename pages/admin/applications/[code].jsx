      ...
      {isLoading ? (
        ...
        <Stack margin="auto" w="90vw" maxWidth="700px" align="center">
          ...
          <StyledFormControl label="الكود">
            <Input readOnly value={data.code} variant="flushed" type="number" />
          </StyledFormControl>
          ...
          <StyledFormControl label="العمر">
            <Input readOnly value={data.age} variant="flushed" type="number" />
          </StyledFormControl>
          <StyledFormControl label="للهدف من الدايت">
            <Input readOnly value={data.target} variant="flushed" type="text" />
          </StyledFormControl>
          ...
          <StyledFormControl label={"ملاحظات"}>
            <Input readOnly value={data.notes} variant="flushed" type="text" />
          </StyledFormControl>
